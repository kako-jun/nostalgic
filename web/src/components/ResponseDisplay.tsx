...
export default function ResponseDisplay({ response, responseType, show = true }: ResponseDisplayProps) {
  ...
  const renderResponse = () => {
    switch (responseType) {
      case 'svg':
        return (
          <div style={{ textAlign: "center", padding: "10px", border: "1px solid #ccc", backgroundColor: "#f9f9f9" }}>
