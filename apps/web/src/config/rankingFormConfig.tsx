...
export const getRankingFormSections = (
  ...
  {
    title: "◆STEP 2: スコア登録◆",
    apiUrl: `https://api.nostalgic.llll-ll.com/ranking?action=submit&id=${encodeURIComponent(publicId || "公開ID")}&name=${encodeURIComponent(submitName || "名前")}&score=${submitScore || "スコア"}${submitDisplayScore ? `&displayScore=${encodeURIComponent(submitDisplayScore)}` : ""}`,
    apiUrlDisplay: (
      <>
  ...
  // Get
  {
    ...
    apiUrl: `https://api.nostalgic.llll-ll.com/ranking?action=get&id=${encodeURIComponent(publicId || "公開ID")}`,
    apiUrlDisplay: (
      <>
        https://api.nostalgic.llll-ll.com/ranking?action=get&id=
        <GreenParam>{publicId || "公開ID"}</GreenParam>
      </>
    ),
    fields: [
  ...
  // Confirm Public ID
  {
    ...
    apiUrl: `https://api.nostalgic.llll-ll.com/ranking?action=create&url=${encodeURIComponent(sharedUrl || "サイトURL")}&token=${encodeURIComponent(sharedToken || "オーナートークン")}`,
    apiUrlDisplay: (
      <>
        https://api.nostalgic.llll-ll.com/ranking?action=create&url=
  ...
  {
    title: "◆スコアを更新したいときは？◆",
    apiUrl: `https://api.nostalgic.llll-ll.com/ranking?action=update&url=${encodeURIComponent(sharedUrl || "サイトURL")}&token=${encodeURIComponent(sharedToken || "オーナートークン")}&name=${encodeURIComponent(updateName || "名前")}&score=${updateScore || "スコア"}${updateDisplayScore ? `&displayScore=${encodeURIComponent(updateDisplayScore)}` : ""}`,
    apiUrlDisplay: (
      <>
  ...
  {
    title: "◆エントリを削除したいときは？◆",
    apiUrl: `https://api.nostalgic.llll-ll.com/ranking?action=remove&url=${encodeURIComponent(sharedUrl || "サイトURL")}&token=${encodeURIComponent(sharedToken || "オーナートークン")}&name=${encodeURIComponent(removeName || "名前")}`,
    apiUrlDisplay: (
      <>
        https://api.nostalgic.llll-ll.com/ranking?action=remove&url=
        <GreenParam>{sharedUrl || "サイトURL"}</GreenParam>
        &token=<GreenParam>{sharedToken || "オーナートークン"}</GreenParam>&name=
  ...
  // Clear
  {
    ...
    apiUrl: `https://api.nostalgic.llll-ll.com/ranking?action=clear&url=${encodeURIComponent(sharedUrl || "サイトURL")}&token=${encodeURIComponent(sharedToken || "オーナートークン")}`,
    apiUrlDisplay: (
      <>
        https://api.nostalgic.llll-ll.com/ranking?action=clear&url=
        <GreenParam>{sharedUrl || "サイトURL"}</GreenParam>
        &token=<GreenParam>{sharedToken || "オーナートークン"}</GreenParam>
      </>
    ),
  ...
  // Delete
  {
    ...
    apiUrl: `https://api.nostalgic.llll-ll.com/ranking?action=delete&url=${encodeURIComponent(sharedUrl || "サイトURL")}&token=${encodeURIComponent(sharedToken || "オーナートークン")}`,
    apiUrlDisplay: (
      <>
        https://api.nostalgic.llll-ll.com/ranking?action=delete&url=
        <GreenParam>{sharedUrl || "サイトURL"}</GreenParam>
        &token=<GreenParam>{sharedToken || "オーナートークン"}</GreenParam>
      </>
    ),
