    ...
    this.shadowRoot.innerHTML = `
      <style>
        :host {
          ...
          --kawaii-light-dots: radial-gradient(circle at 0px 0px, rgba(255,255,255,0.8) 8px, transparent 8px),
          ...
          --kawaii-light-dots-hover: radial-gradient(circle at 0px 0px, rgba(255,255,255,0.9) 8px, transparent 8px),
                                     radial-gradient(circle at 30px 5px, rgba(255,255,255,0.9) 10px, transparent 10px),
                                     radial-gradient(circle at 65px 0px, rgba(255,255,255,0.9) 7px, transparent 7px),
                                     radial-gradient(circle at 100px 8px, rgba(255,255,255,0.9) 9px, transparent 9px),
                                     radial-gradient(circle at 135px 2px, rgba(255,255,255,0.9) 6px, transparent 6px),
                                     radial-gradient(circle at 170px 10px, rgba(255,255,255,0.9) 11px, transparent 11px),
                                     radial-gradient(circle at 5px 25px, rgba(255,255,255,0.9) 7px, transparent 7px),
                                     radial-gradient(circle at 40px 30px, rgba(255,255,255,0.9) 8px, transparent 8px),
                                     radial-gradient(circle at 75px 20px, rgba(255,255,255,0.9) 12px, transparent 12px),
                                     radial-gradient(circle at 110px 35px, rgba(255,255,255,0.9) 6px, transparent 6px),
                                     radial-gradient(circle at 145px 25px, rgba(255,255,255,0.9) 9px, transparent 9px),
                                     radial-gradient(circle at 180px 30px, rgba(255,255,255,0.9) 7px, transparent 7px),
                                     radial-gradient(circle at 15px 50px, rgba(255,255,255,0.9) 10px, transparent 10px),
                                     radial-gradient(circle at 50px 55px, rgba(255,255,255,0.9) 8px, transparent 8px),
                                     radial-gradient(circle at 85px 45px, rgba(255,255,255,0.9) 6px, transparent 6px),
                                     radial-gradient(circle at 120px 60px, rgba(255,255,255,0.9) 11px, transparent 11px),
                                     radial-gradient(circle at 155px 50px, rgba(255,255,255,0.9) 9px, transparent 9px),
                                     radial-gradient(circle at 0px 75px, rgba(255,255,255,0.9) 7px, transparent 7px),
                                     radial-gradient(circle at 35px 80px, rgba(255,255,255,0.9) 10px, transparent 10px),
                                     radial-gradient(circle at 70px 70px, rgba(255,255,255,0.9) 8px, transparent 8px),
                                     radial-gradient(circle at 105px 85px, rgba(255,255,255,0.9) 6px, transparent 6px),
                                     radial-gradient(circle at 140px 75px, rgba(255,255,255,0.9) 12px, transparent 12px),
                                     radial-gradient(circle at 175px 80px, rgba(255,255,255,0.9) 9px, transparent 9px),
                                     radial-gradient(circle at 25px 100px, rgba(255,255,255,0.9) 8px, transparent 8px),
                                     radial-gradient(circle at 60px 105px, rgba(255,255,255,0.9) 7px, transparent 7px),
                                     radial-gradient(circle at 95px 110px, rgba(255,255,255,0.9) 10px, transparent 10px),
                                     radial-gradient(circle at 130px 100px, rgba(255,255,255,0.9) 6px, transparent 6px),
                                     radial-gradient(circle at 165px 115px, rgba(255,255,255,0.9) 9px, transparent 9px);
        }
